...
with(hhpowercons2,plot(hhpowercons2$DT,hhpowercons2$Global_active_power, type = "l", ylab = "Global Active Power", xlab = ""))
with(hhpowercons2,plot(hhpowercons2$DT,hhpowercons2$Voltage, type = "l", ylab = "Voltage", xlab = "datetime"))
...
with(hhpowercons2,plot(hhpowercons2$DT,hhpowercons2$Global_reactive_power, type = "l", ylab = "Global_reactive_power", xlab = "datetime"))
dev.off()
